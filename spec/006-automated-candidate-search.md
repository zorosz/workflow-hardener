...
Validation for this implementation: reviewed request destinations and authentication, redirect refusal, metadata validation, sampling/byte/time limits, regex boundaries, deduplication, partial results, and output-file handling. Go formatting and tracked/new-file whitespace checks passed. [Scanner CI passed](https://github.com/zorosz/workflow-hardener/actions/runs/35506005058) on 2026-09-20 for commit `5012e01726aab29061414020af0db18c623fabd3`: `go test ./...`, `go vet ./...`, both executable builds, and all seven scanner demos. The discovery tests used simulated HTTP responses and synthetic tokens. Live candidate discovery has not been run, and no generated project code has been executed locally.
